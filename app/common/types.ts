...
export interface GameSettings {
  ...
  /**
   * e.g. mode.unranked-2022-12-20T06:52:39.18-0
   */
  readonly matchId: string;
  /**
   * For a given matchId, starts at 1.
   */
  readonly gameNumber: number;
  /**
   * For a given gameNumber, 0 if not a tiebreaker.
   */
  readonly tiebreakerNumber: number;
